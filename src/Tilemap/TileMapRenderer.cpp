...
//        rect.setSize(sf::Vector2f(tileMap.getWidth() * 128, 1));
//        rect.setPosition(sf::Vector2f(0, 128 * i));
//        target.draw(rect);
//    }
//
...
//    {
//        sf::RectangleShape rect;
//        rect.setSize(sf::Vector2f(1, tileMap.getHeight() * 128));
//        rect.setPosition(sf::Vector2f(128 * i, 0));
//        target.draw(rect);
//    }
}
